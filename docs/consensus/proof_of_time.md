...
![Screenshot 2023-06-01 at 13.48.06.png](Dilithium%20PoT%20Specification%204e17a6d5b03a4abea864ba2d0b97970e/Screenshot_2023-06-01_at_13.48.06.png) -->
...
5. For each pair of `checkpoints[i]` and `checkpoints[i+1]`run:
    ...
    <!-- 
    TODO : replace diagram
    ![Subspace v2 Master - Consensus (2).png](Dilithium%20PoT%20Specification%204e17a6d5b03a4abea864ba2d0b97970e/Subspace_v2_Master_-_Consensus_(2).png) -->
...
- Implementation note about Timekeeper transition
...
<!-- TODO replace image![Subspace v2 Master - Consensus.png](Dilithium%20PoT%20Specification%204e17a6d5b03a4abea864ba2d0b97970e/Subspace_v2_Master_-_Consensus.png) -->
...
Explanation
    ...
    ![Screenshot 2023-09-20 at 17.23.12.png](Dilithium%20PoT%20Specification%204e17a6d5b03a4abea864ba2d0b97970e/Screenshot_2023-09-20_at_17.23.12.png) 
    
    
    TODO : replace diagram
    Close-up to last 15k blocks
    
    ![Screenshot 2023-09-20 at 17.24.37.png](Dilithium%20PoT%20Specification%204e17a6d5b03a4abea864ba2d0b97970e/Screenshot_2023-09-20_at_17.24.37.png)
