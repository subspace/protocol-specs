...
![Subspace v2 Master - Domains (2).png](Messaging%20Specification%20(XDM)%20v2%206e8b9d3bb2c94e289d70f9e0474b9f9b/Subspace_v2_Master_-_Domains_(2).png)
...
2. Next available `ChannelID` is used to assign the new channel.
...
1. Channel is initiated by `src_chain_id` as described [Initiate Channel](https://www.notion.so/Initiate-Channel-20534623d5594a78aa83c256fe844718?pvs=21) 
...
Since XDM inherently a request response protocol it may require a response in some cases.
...
Where `K = Archiving depth` (currently 100 consensus blocks) and $`D_k$ = Domain challenge period` (currently 14400 domain blocks)
...
| --- | --- | --- |
| 2 * K + $D_k$ | $D_k$ + 2 * K | 2 * K + 2 * $D_k$ |

# OLD

**This following is the high level workflow how the channel is opened**

![channel.svg](Messaging%20Specification%20(XDM)%20v2%206e8b9d3bb2c94e289d70f9e0474b9f9b/channel.svg)

**The following is the high level workflow how channel connection is closed**

![channel_close.svg](Messaging%20Specification%20(XDM)%20v2%206e8b9d3bb2c94e289d70f9e0474b9f9b/channel_close.svg)

**The following is the high level workflow of Endpoint message passing**

![uml.svg](Messaging%20Specification%20(XDM)%20v2%206e8b9d3bb2c94e289d70f9e0474b9f9b/uml.svg)
